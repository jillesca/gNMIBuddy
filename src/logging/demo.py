...
def demo_cli_integration():
    ...
    print("python gbuddy.py --log-level debug --device xrd-1 interfaces")
    print()
    print("# Module-specific logging:")
    print("python gbuddy.py --log-level info \\")
    ...
    print("python gbuddy.py --log-level info --structured-logging \\")
    print("  --device xrd-1 interfaces")
    print()
    print("# Dynamic log level management:")
    print("python gbuddy.py --device xrd-1 log-level show")
    print("python gbuddy.py --device xrd-1 log-level set gnmibuddy.gnmi debug")
    print("python gbuddy.py --device xrd-1 log-level modules")
    print()
